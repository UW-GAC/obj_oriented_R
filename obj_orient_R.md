...
Most CRAN packages (including the tidyverse) use S3. S3 is very easy, but often it's too easy: with no formal classes, you can do things that make no sense.
...
```
    ...
    ## <bytecode: 0x7fa5b1649ab0>
    ## <environment: 0x7fa5b0147f08>
